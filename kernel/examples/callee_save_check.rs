...
// TODO: reviewer false positive — this file has only the bootable form (no no_boot variant).
// The macro-generated boot() is called from main(); no_boot would be incorrect here.
...
fn main() -> ! {
    ...
    // TODO: reviewer false positive — store_kernel and boot are generated by
    // define_unified_harness! (via define_unified_kernel! / define_kernel_runtime!),
    // not imported from the kernel crate.
    store_kernel(k);
