...
kernel::define_unified_harness!(Cfg, N, SW, |tick, _k| {
...
fn main() -> ! {
    ...
    let cfgs = PartitionConfig::sentinel_array::<N>(SW);
    ...
    store_kernel(k);
    let parts: [(extern "C" fn() -> !, u32); N] = [(partition_0_entry, 0), (partition_1_entry, 0)];
