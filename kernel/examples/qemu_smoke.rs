...
//!
//! 1. Kernel boots with two partitions via `define_harness!`.
...
kernel::define_harness!(SmokeConfig, |tick, _k| {
...
// NOTE: `store_kernel` and `boot` are generated by `define_harness!`
