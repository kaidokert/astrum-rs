...
//!
//! 1. Kernel boots with two partitions via `define_kernel!`.
...
kernel::kernel_config!(SmokeConfig<Partitions2, SyncMinimal, MsgMinimal, PortsTiny, DebugEnabled>);
...
// NOTE: `store_kernel` and `boot` are generated by `define_kernel!`
...
fn main() -> ! {
    ...
    let mut sched = ScheduleTable::<{ SmokeConfig::SCHED }>::round_robin(2, 3)
