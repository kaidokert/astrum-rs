...
//!
//! Boots a single-partition kernel via `define_kernel!` and checks
...
kernel::define_kernel!(BannerConfig, |tick, _k| {
    // The boot banner is printed by define_kernel! during boot(),
