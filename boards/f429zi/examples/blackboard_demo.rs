//! Blackboard Demo for STM32F429ZI
//!
...
fn main() -> ! {
    ...
    rprintln!("STM32F429ZI - Shared Status Board Pattern");
    ...
    // Blackboard ID is deterministic: first created = 0
    let bb: u32 = 0;

    // All partitions get the same blackboard ID
