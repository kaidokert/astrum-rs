 ...
 * Required by cortex-m-rt when built with the `device` feature
 * (which the kernel crate enables unconditionally).
 * All entries default to DefaultHandler; override with #[interrupt] in user code.
 *
 * Source: nRF52833 Product Specification v1.3, Table 13 (IRQ assignments)
 */
