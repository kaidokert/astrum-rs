//! Message Queue Demo for nRF52833 (PCA10100)
//!
...
//!
//! Build: cd nrf52 && cargo build --example msg_demo --features kernel-example
...
fn main() -> ! {
    ...
    let parts: [PartitionSpec; NUM_PARTITIONS] = [
        PartitionSpec::entry(sender_main), // queue_id = 0
    ...
    rprintln!("[INIT] Booting: P0=sender P1=receiver queue_id=0\n");
